      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-br from-primary to-secondary py-16 text-white">
          <div className="mx-auto max-w-7xl px-4 text-center lg:px-8">
            <h1 className="text-3xl font-bold md:text-4xl lg:text-5xl">Tentang Kami</h1>
          ...
          <div className="mx-auto max-w-7xl px-4 lg:px-8">
            ...
            <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              <div className="rounded-xl bg-card p-6 text-center shadow-sm">
                <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-card-blue/10">
                  <BookOpen className="h-6 w-6 text-card-blue" />
                </div>
                <h3 className="font-semibold text-foreground">Materi Lengkap</h3>
              ...
              <div className="rounded-xl bg-card p-6 text-center shadow-sm">
                <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-card-orange/10">
                  <GraduationCap className="h-6 w-6 text-card-orange" />
                </div>
                <h3 className="font-semibold text-foreground">Video Pembelajaran</h3>
                <p className="mt-2 text-sm text-muted-foreground">
              ...
              <div className="rounded-xl bg-card p-6 text-center shadow-sm">
                <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-card-green/10">
                  <Users className="h-6 w-6 text-card-green" />
                </div>
                <h3 className="font-semibold text-foreground">Latihan Soal</h3>
                <p className="mt-2 text-sm text-muted-foreground">
              ...
              <div className="rounded-xl bg-card p-6 text-center shadow-sm">
                <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-card-red/10">
                  <Heart className="h-6 w-6 text-card-red" />
                </div>
                <h3 className="font-semibold text-foreground">Gratis</h3>
                <p className="mt-2 text-sm text-muted-foreground">
            ...
            <div className="mx-auto mt-12 max-w-md">
              <div className="rounded-xl bg-card p-8 text-center shadow-sm">
                <div className="mx-auto mb-4 flex h-24 w-24 items-center justify-center rounded-full bg-primary/10">
                  <span className="text-4xl font-bold text-primary">SN</span>
                </div>
                <h3 className="text-xl font-bold text-foreground">Siti Nur Ambar</h3>
                <p className="mt-1 text-sm text-muted-foreground">Mahasiswa UNISDA</p>
